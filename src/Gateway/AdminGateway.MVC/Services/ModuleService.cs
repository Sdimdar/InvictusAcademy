...
public class ModuleService : IModulesService
{
    ...
    public ModuleService(ExtendedHttpClient<IModulesService> extendedHttpClient)
    {
    ...
    public async Task<ActionResult<DefaultResponseObject<ModuleInfoVm>>> AddArticle(AddArticlesCommand request)
    {
        return await ExtendedHttpClient
            .PostAndReturnResponseAsync<AddArticlesCommand, DefaultResponseObject<ModuleInfoVm>>(request,
                "/Modules/AddArticles");
    }
    ...
    {
        return await ExtendedHttpClient
            .PostAndReturnResponseAsync<CreateModuleCommand, DefaultResponseObject<ModuleInfoVm>>(request,
                "/Modules/Create");
    }
    ...
    public async Task<ActionResult<DefaultResponseObject<ModuleInfoVm>>> Delete(DeleteModuleCommand request)
    {
        ...
        return await ExtendedHttpClient
            .PostAndReturnResponseAsync<DeleteModuleCommand, DefaultResponseObject<ModuleInfoVm>>(request,
                "/Modules/Delete");
    }
    ...
    {
        return await ExtendedHttpClient
            .GetAndReturnResponseAsync<GetModulesByFilterStringQuery, DefaultResponseObject<List<ModuleInfoVm>>>(request,
                "/Module/GetByFilterString");
    }

    public async Task<ActionResult<DefaultResponseObject<ModuleInfoVm>>> GetById(GetModuleByIdQuery request)
    {
        return await ExtendedHttpClient
            .GetAndReturnResponseAsync<GetModuleByIdQuery, DefaultResponseObject<ModuleInfoVm>>(request,
                "/Module/GetById");
    }
    ...
    {
        return await ExtendedHttpClient
            .GetAndReturnResponseAsync<GetModulesByListOfIdQuery, DefaultResponseObject<List<ModuleInfoVm>>>(request,
                "/Modules/GetByListOfId");
    }

    public async Task<ActionResult<DefaultResponseObject<ModuleInfoVm>>> Update(UpdateModuleCommand request)
    {
        return await ExtendedHttpClient
            .PostAndReturnResponseAsync<UpdateModuleCommand, DefaultResponseObject<ModuleInfoVm>>(request,
                "/Modules/Update");
    }
}